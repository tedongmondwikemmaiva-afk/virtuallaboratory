    ...
    Private Sub CreateNavItem(iconKey As String, label As String, isActive As Boolean, y As Integer)
        ...
        If Not isActive Then
            If iconKey = "grid" Then
                ' Open the Apparatus screen from Home without stacking modal dialogs.
            ...
            ElseIf iconKey = "beaker" Then
                ' Open the Chemicals screen from Home without stacking modal dialogs.
            ...
            ElseIf iconKey = "cap" Then
                ' Open the Teacher Dashboard from Home without stacking modal dialogs.
            ...
            ElseIf iconKey = "chart" Then
                ' Open Reports & Grades from Home without stacking modal dialogs.
            ...
            ElseIf iconKey = "question" Then
                ' Open Quizzes from Home without stacking modal dialogs.
