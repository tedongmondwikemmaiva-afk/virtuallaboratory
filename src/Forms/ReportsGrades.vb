...
Public Class ReportsGrades
    ...
    Private ReadOnly assessments As New List(Of AssessmentRow) From {
        New AssessmentRow With {.Name = "Acid & Base Reaction", .Type = "Practical", .Date = "12 Jul 2026", .Score = "92%", .Status = "Graded"},
        New AssessmentRow With {.Name = "Precipitation Reaction", .Type = "Practical", .Date = "18 Jul 2026", .Score = "78%", .Status = "Graded"},
        New AssessmentRow With {.Name = "Titration Quiz", .Type = "Quiz", .Date = "21 Jul 2026", .Score = "85%", .Status = "Graded"},
        New AssessmentRow With {.Name = "Gas Evolution Report", .Type = "Report", .Date = "24 Jul 2026", .Score = "—", .Status = "Pending"},
        New AssessmentRow With {.Name = "Flame Test", .Type = "Practical", .Date = "28 Jul 2026", .Score = "88%", .Status = "Graded"}
    }
    ...
    Private Sub BuildAssessmentHistoryPanel(x As Integer, y As Integer, w As Integer)
        ...
        For Each a In assessments
            ...
            Dim lblDate As New Label() With {.Text = a.Date, .Font = New Font("Segoe UI", 9), .ForeColor = Color.FromArgb(170, 176, 196),
